from utils.GeneralNewsExtractor.utils import pre_parse, remove_noise_node
from utils.GeneralNewsExtractor.extractor import ContentExtractor, \
    TitleExtractor, TimeExtractor, AuthorExtractor
