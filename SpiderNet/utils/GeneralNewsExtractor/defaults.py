...
USELESS_TAG = ['style', 'script', 'link', 'video', 'iframe', 'source',
               'picture', 'header']

"""
if one tag in the follow list does not contain any child node nor content, 
it could be removed
"""
TAGS_CAN_BE_REMOVE_IF_EMPTY = ['div', 'section', 'h1', 'h2', 'h3', 'h4',
                               'h5', 'h6', 'span']
